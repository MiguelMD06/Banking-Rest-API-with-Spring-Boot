...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> badRequestExceptionHandler(
    ...
    public ResponseEntity<ErrorDetails> unprocessableContentExceptionHandler(
    ...
    public ResponseEntity<ErrorDetails> genericExceptionHandler(
            Exception exception,
            WebRequest webRequest){
